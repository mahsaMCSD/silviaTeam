            ...
            <div className="about-page-content-part rel z-2 rmb-55">
              <div className="section-title mb-35 wow fadeInUp delay-0-2s">
                ...
                <p>
                  ...
                  UI/UX designers, and problem-solvers. With expertise in modern
                  frameworks like Vue.js, Nuxt, and backend technologies like
                  Python and Django, we bring your ideas to life with precision
                  and creativity. From seamless user interfaces to scalable
                  backend systems, we deliver solutions that meet your needs.
                </p>
              </div>
